...
class Data:
    """
    Returned by :meth:`~subway.websockets.ServerWebSocket.receive`.
    ...
    def is_close_frame(self) -> bool:
        """
        True if the frame is a close frame.
        """
        return self.frame.close_code is not None

    def is_control_frame(self) -> bool:
        """
        True if the frame is a control frame.
        """
        return self.frame.is_control()
