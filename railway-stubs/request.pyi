...
class Request:
    ...
    def __init__(self, method: str, url: str, headers: Dict[str, str], version: str, body: bytes, app: Application, connection: ClientConnection, worker: Worker, created_at: datetime.datetime) -> None: ...
    ...
    def redirect(self, to: Union[str, URL], *, body: Any=..., headers: Optional[Dict[str, Any]]=..., status: Optional[int]=..., content_type: Optional[str]=...) -> Redirection: ...
    @classmethod
