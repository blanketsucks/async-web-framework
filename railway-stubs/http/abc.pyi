...
class Hooker:
    ...
    def getaddrinfo(self, host: Optional[str]=..., port: Optional[int]=...) -> AsyncIterator[Tuple[AddressFamily, SocketKind, int, str, Union[Tuple[str, int], Tuple[str, int, int, int]]]]: ...
